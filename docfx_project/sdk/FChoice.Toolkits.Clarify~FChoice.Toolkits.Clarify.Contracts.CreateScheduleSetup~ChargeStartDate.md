### ChargeStartDate Property (CreateScheduleSetup)

The charging start DateTime for the Schedule. If not set, the current time is used.
...
Public Property ChargeStartDate As Date
```
