...
Link a Case to a Workaround. This overload takes a setup object and a database transaction.
...
Public Overloads Function LinkCaseToWorkaround( _
   ByVal _setupParam_ As LinkCaseToWorkaroundSetup, _
...
public ToolkitResult LinkCaseToWorkaround( 
   LinkCaseToWorkaroundSetup _setupParam_,
