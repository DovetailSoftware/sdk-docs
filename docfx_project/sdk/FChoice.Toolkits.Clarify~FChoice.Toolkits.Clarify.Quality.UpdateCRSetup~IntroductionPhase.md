     IntroductionPhase Property (UpdateCRSetup)                                                   

fcSDK Documentation

IntroductionPhase Property (UpdateCRSetup)

Element from the 'CR Domain' application list. If not set, the default list value is used.
...
Public Property IntroductionPhase As String
