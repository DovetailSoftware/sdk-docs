### PrimaryUse Property (UpdateSiteByObjidSetup)

Element from the 'Primary Use' user defined list. If not set, the default list value is used.
...
Public Property PrimaryUse As String
```
