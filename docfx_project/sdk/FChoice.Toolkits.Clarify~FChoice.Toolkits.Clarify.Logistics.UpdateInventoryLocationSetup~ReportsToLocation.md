### ReportsToLocation Property (UpdateInventoryLocationSetup)

Name of the inventory location to which this new inventory location reports
...
Public Property ReportsToLocation As String
```
