### AsReadOnly Method (IHierarchicalStringListCollection)
...
Function AsReadOnly() As ReadOnlyCollection(Of IHierarchicalStringList)
```

```csharp
ReadOnlyCollection<IHierarchicalStringList> AsReadOnly()
```
