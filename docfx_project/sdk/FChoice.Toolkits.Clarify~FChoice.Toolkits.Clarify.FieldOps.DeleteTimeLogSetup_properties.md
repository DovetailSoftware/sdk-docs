     DeleteTimeLogSetup Class Properties                                                   

fcSDK Documentation

DeleteTimeLogSetup Class Properties

For a list of all members of this type, see [DeleteTimeLogSetup members](FChoice.Toolkits.Clarify~FChoice.Toolkits.Clarify.FieldOps.DeleteTimeLogSetup_members.md).

Public Properties

|   | Name | Description |
| --- | --- | --- |
| ![Public Property](dotnetimages/publicProperty.png) | [LastModifiedDate](FChoice.Toolkits.Clarify~FChoice.Toolkits.Clarify.FieldOps.DeleteTimeLogSetup~LastModifiedDate.md) | The DateTime the Time Log was deleted. If not set, the current time is used.   |
...
[DeleteTimeLog(DeleteTimeLogSetup) Method](FChoice.Toolkits.Clarify~FChoice.Toolkits.Clarify.FieldOps.FieldOpsToolkit~DeleteTimeLog(DeleteTimeLogSetup).md)