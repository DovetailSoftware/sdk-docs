### GetSubcaseTimeAndExpensesSetup Class Members

The following tables list the members exposed by [GetSubcaseTimeAndExpensesSetup](FChoice.Toolkits.Clarify~FChoice.Toolkits.Clarify.Support.GetSubcaseTimeAndExpensesSetup.md).

Public Constructors

|   | Name | Description |
| --- | --- | --- |
| ![Public Constructor](dotnetimages/publicConstructor.png) | [GetSubcaseTimeAndExpensesSetup Constructor](FChoice.Toolkits.Clarify~FChoice.Toolkits.Clarify.Support.GetSubcaseTimeAndExpensesSetup~_ctor.md) | Initializes a new instance of the GetSubcaseTimeAndExpensesSetup class.   |
