### UserName Property (ForwardQuoteSetup)

The user who has forwarded the Quote. If not set, the Toolkit session user is used.
...
[ForwardQuoteSetup Members](FChoice.Toolkits.Clarify~FChoice.Toolkits.Clarify.Sales.ForwardQuoteSetup_members.md)