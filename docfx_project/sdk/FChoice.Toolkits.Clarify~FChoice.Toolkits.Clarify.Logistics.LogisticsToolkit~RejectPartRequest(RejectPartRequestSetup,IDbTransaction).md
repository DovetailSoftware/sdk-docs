...
Reject the PartRequest from the queue in which it currently resides, and return it to the owner. This overload takes a setup object and a database transaction.
...
Public Overloads Function RejectPartRequest( _
   ByVal _setupParam_ As RejectPartRequestSetup, _
