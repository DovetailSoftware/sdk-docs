...
Dispatch the Opportunity to the specified queue. This overload takes a setup object and a database transaction.
...
Public Overloads Function DispatchOpportunity( _
   ByVal _setupParam_ As DispatchOpportunitySetup, _
