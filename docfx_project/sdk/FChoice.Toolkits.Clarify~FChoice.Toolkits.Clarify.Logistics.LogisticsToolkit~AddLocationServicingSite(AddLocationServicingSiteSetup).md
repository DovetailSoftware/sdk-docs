...
Used to relate sites to the inventory locations that service them. This overload takes a setup object.
...
Public Overloads Function AddLocationServicingSite( _
   ByVal _setupParam_ AddLocationServicingSiteSetup _
) As ToolkitResult
```
