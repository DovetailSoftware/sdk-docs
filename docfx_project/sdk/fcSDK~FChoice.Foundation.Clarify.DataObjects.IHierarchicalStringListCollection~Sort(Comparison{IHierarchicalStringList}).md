### Sort(Comparison<IHierarchicalStringList>) Method
...
Overloads Sub Sort( _
   ByVal _comparison_ As Comparison(Of IHierarchicalStringList) _
)
```

```csharp
void Sort( 
   Comparison<IHierarchicalStringList> _comparison_
)
```
