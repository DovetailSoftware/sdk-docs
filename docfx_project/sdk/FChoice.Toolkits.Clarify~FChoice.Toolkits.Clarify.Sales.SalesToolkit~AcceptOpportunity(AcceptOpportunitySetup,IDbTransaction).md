...
Accept the specified Opportunity from the queue in which it is currently dispatched. This overload takes a setup object and a database transaction.
...
Public Overloads Function AcceptOpportunity( _
   ByVal _setupParam_ As AcceptOpportunitySetup, _
