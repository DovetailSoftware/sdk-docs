...
| --- | --- |
| [LogPartsUsedUpgrade(String,Int32,String,String,String,String)](FChoice.Toolkits.Clarify~FChoice.Toolkits.Clarify.FieldOps.FieldOpsToolkit~LogPartsUsedUpgrade(String,Int32,String,String,String,String).md) |   |
| [LogPartsUsedUpgrade(String,Int32,String,String,String,Int32)](FChoice.Toolkits.Clarify~FChoice.Toolkits.Clarify.FieldOps.FieldOpsToolkit~LogPartsUsedUpgrade(String,Int32,String,String,String,Int32).md) |   |
| [LogPartsUsedUpgrade(String,String,Int32,String,String,String,String)](FChoice.Toolkits.Clarify~FChoice.Toolkits.Clarify.FieldOps.FieldOpsToolkit~LogPartsUsedUpgrade(String,String,Int32,String,String,String,String).md) |   |
| [LogPartsUsedUpgrade(String,String,Int32,String,String,String,Int32)](FChoice.Toolkits.Clarify~FChoice.Toolkits.Clarify.FieldOps.FieldOpsToolkit~LogPartsUsedUpgrade(String,String,Int32,String,String,String,Int32).md) |   |
| [LogPartsUsedUpgrade(LogPartsUsedUpgradeSetup)](FChoice.Toolkits.Clarify~FChoice.Toolkits.Clarify.FieldOps.FieldOpsToolkit~LogPartsUsedUpgrade(LogPartsUsedUpgradeSetup).md) |   |
| [LogPartsUsedUpgrade(LogPartsUsedUpgradeSetup,IDbTransaction)](FChoice.Toolkits.Clarify~FChoice.Toolkits.Clarify.FieldOps.FieldOpsToolkit~LogPartsUsedUpgrade(LogPartsUsedUpgradeSetup,IDbTransaction).md) | Used to upgrade an existing site part with a new site part. This overload takes a setup object and a database transaction.   |
