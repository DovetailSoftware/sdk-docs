## FCFL API Toolkit for ClearSupport

---

**Overview**

Many customers have wanted the ability to customize the Clarify environment easily by adding base Clarify functions (such as case creation, closure, modification, or note logging) to web applications.

The **First Choice Software FCFL API Toolkit for Clear Support** solves these problems, as well as many others. The toolkit is a series of COM functions that you may add to your customizations.
