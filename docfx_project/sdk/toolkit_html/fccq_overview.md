...
The **First Choice Software FCFL API Toolkit for Clear Quality** solves these problems, as well as many others. The toolkit is a series of COM functions that you may add to your customizations.
