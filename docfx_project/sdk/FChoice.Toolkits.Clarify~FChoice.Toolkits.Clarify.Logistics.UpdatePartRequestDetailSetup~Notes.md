### Notes Property (UpdatePartRequestDetailSetup)

Notes about the Part Request Detail update
...
If this property has not been set no change will occur. If the property is set, even to an empty string, that value will be reflected in the update.
