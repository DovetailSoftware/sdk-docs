### ParentRelation Property (ClarifyGeneric)
...
```vbnet
' Declaration
Public ReadOnly Property ParentRelation As [SchemaRelation](fcSDK~FChoice.Foundation.Clarify.Schema.SchemaRelation.md)

public [SchemaRelation](fcSDK~FChoice.Foundation.Clarify.Schema.SchemaRelation.md) ParentRelation {get;}
